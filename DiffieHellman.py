...
class DiffieHellman(object):
    def __init__(self, name, file_name, generator=2, group=17, keyLength=1024):
        default_generator = 2
    ...
    def publishKey(self):
        with open(self.file_name, "a") as file:
            file.write(f"{self.name}-key:{str(self.publicKey)}\n")
    def readKey(self):
        iteration = 0
        while True:
            try:
                ...
                for line in reversed(lines):
                    ...
                    if self.name not in formattedLine and formattedLine != str(self.publicKey) and "|" not in formattedLine:
